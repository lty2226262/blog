...
public class DList {
  ...
  public void insertFront(Object item) {
    DListNode toInsert = newNode(item,head,head.next);
  ...
  public void insertBack(Object item) {
    DListNode toInsert = newNode(item,head.prev,head);
  ...
  public void insertAfter(Object item, DListNode node) {
    // Your solution here.
    if (node != null){
      DListNode toInsert = newNode(item,node,node.next);
  ...
  public void insertBefore(Object item, DListNode node) {
    // Your solution here.
    if (node != null){
      DListNode toInsert = newNode(item,node.prev,node);
