...
public class RunIterator implements Iterator {
  ...
  private DListNode currentDListNode;
  private DListNode headNode;
  ...
  // the encoding.
  RunIterator(DList tempDList) {
    headNode = tempDList.head;
    currentDListNode = tempDList.head;
  ...
  public boolean hasNext() {
    ...
    if (currentDListNode.next == headNode) return false;
    else return true;
  }
  ...
  public int[] next() {
    ...
    if (this.hasNext() == true){
      currentDListNode = currentDListNode.next;
      int[] tempArray = {currentDListNode.numberOfPixel,currentDListNode.valueOfPixel.red,currentDListNode.valueOfPixel.green,currentDListNode.valueOfPixel.blue};
      return tempArray;
    } else {
