...
public class SList {
  ...
  public void squish() {
    ...
    SListNode CurrentListNode;
    if (head == null) ;
    else{
      CurrentListNode = head;
      while (CurrentListNode.next != null){
        if ((CurrentListNode.next.item).equals(CurrentListNode.item)){
  ...
  public void twin() {
    ...
    if (head == null) ;
      ...
      while (currentNode != null){
        SListNode duplicateNode = new SListNode(currentNode.item,currentNode.next);
